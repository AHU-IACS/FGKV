...
struct FG_Stats {
    ...
    uint64_t fg_getchosenregions_time;
    // uint64_t fg_apply_time;
    // uint64_t fg_saveto_time;

    uint64_t pick_compaction_time[6];
    uint32_t minor_compaction_count_in_l0;
    uint32_t minor_compaction_count_in_cluster;
    uint32_t minor_compaction_count_in_patch;
    uint32_t l0_doc_count;
    uint32_t fg_cluster_compaction_count;
    uint32_t fg_patch_compaction_count;

    uint64_t minor_compaction_time_in_l0;
    uint64_t minor_compaction_time_in_cluster;
    uint64_t minor_compaction_time_in_patch;
    uint64_t l0_doc_time;
    // cluster分支的时间，包括根表合并中的minor compaction
    uint64_t fg_cluster_compaction_time;
    // !cluster分支的时间，包括子表合并中的minor compaction
    uint64_t fg_patch_compaction_time;
    ...
    int chosen_patch;
    uint64_t chosen_patch_size;

    int total_patch_number_in_cluster_compaction;
    ...
    FG_Stats() : fg_total_write(0), 
                ...
                fg_getchosenregions_time(0), 
                // fg_apply_time(0), 
                // fg_saveto_time(0), 

                pick_compaction_time{0},
                minor_compaction_count_in_l0(0), 
                minor_compaction_count_in_cluster(0), 
                minor_compaction_count_in_patch(0), 
                l0_doc_count(0), 
                fg_cluster_compaction_count(0), 
                fg_patch_compaction_count(0), 

                minor_compaction_time_in_l0(0), 
                minor_compaction_time_in_cluster(0), 
                minor_compaction_time_in_patch(0), 
                l0_doc_time(0), 
                fg_cluster_compaction_time(0), 
                fg_patch_compaction_time(0), 
                ...
                total_patch_number_in_cluster_compaction(0), 
    ...
    void Reset() { 
        ...
        total_patch_number_in_cluster_compaction;
        original_cluster_compaction_count = 0;
